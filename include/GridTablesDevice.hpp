// Auto-generated device-side grid/sign tables for the IQ2_XS / IQ3_S
// GPU kernels. Byte-identical copies of the host tables in
// GridTables.cpp, GridTablesIQ3S.cpp and GGMLDequantize.hpp.
#pragma once
