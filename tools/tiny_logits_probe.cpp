...
//
// Run:
//   TINYCODER_MODEL_PATH=<model.gguf> tiny_logits_probe --file prompt.txt
//      [--tokens] [--generate]
//   (with an inline prompt: TINYCODER_MODEL_PATH=<model.gguf>
//      tiny_logits_probe "prompt text" [--tokens] [--generate] )
